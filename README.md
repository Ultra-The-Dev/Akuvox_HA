...
| **Lock: Lock A/B/…** | Same relay as a *lock* entity (momentary, auto re-locks) — works with Assist, HomeKit & Alexa ("unlock the front door"). |
...
> Requires Home Assistant **2024.6** or newer and FFmpeg available (it ships with
